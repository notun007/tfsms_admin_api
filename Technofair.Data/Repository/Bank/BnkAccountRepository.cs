...
namespace Technofair.Data.Repository.Bank
{
    ...
    #region Interface
    public interface IBnkAccountRepository : IRepository<BnkAccountInfo>
    {
    ...
    public class BnkAccountRepository : AdminBaseRepository<BnkAccountInfo>, IBnkAccountRepository
    {
        public BnkAccountRepository(IAdminDatabaseFactory databaseFactory)
